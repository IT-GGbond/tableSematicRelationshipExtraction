...
class InferenceDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Clean text-pair: raw Subject / Object, matching training format
        input_ids, attention_mask = encode_text_pair(
            self.tokenizer, subject_text, object_text, self.max_length
        )
        return {
            'input_ids': input_ids,
...
def run_inference(args):
    ...
    # Load label mapping (generated by training)
